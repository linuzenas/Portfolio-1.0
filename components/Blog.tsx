...
const Blog = () => {
  ...
  const blogPosts = [
    {
      id: 4,
      title: 'Multimodal student engagement analytics with automated task management for SDG 4 aligned quality online education',
      excerpt: 'This paper presents EduVision Analyzer, a multimodal end-to-end system that bridges student engagement analytics with automated task management to address UN SDG 4 – Quality Education.',
      content: 'This paper presents EduVision Analyzer, a multimodal end-to-end system that bridges student engagement analytics with automated task management to address United Nations (UN) Sustainable Development Goal 4 (SDG 4 – Quality Education). The system accepts post-class video, audio, and live webcam input, applying computer vision for affect estimation, physical activity tracking, and eye-state monitoring, alongside Natural Language Processing (NLP) for lecture summarisation and actionable task extraction.',
      image: '/blog/education-analytics.jpg',
      author: 'P. Linu Zenas Paul',
      date: '2026-06-20',
      readTime: 'Research Paper',
      tags: ['Student engagement', 'Multi-modal analytics', 'Computer vision', 'Emotion recognition', 'Gaze tracking', 'Audio summarization', 'Task management', 'Trello', 'Online education'],
